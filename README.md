...
* **[default_16MB.csv](./default_16MB.csv)**  this is basic partition file with minimum 3.5Mb [spiffs file system](https://docs.espressif.com/projects/esp-idf/en/stable/esp32/api-reference/storage/spiffs.html) and with two 6.5Mb bytes app0 and app1
